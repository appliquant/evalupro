...
Evaluation.belongsTo(Product, { as: 'product', foreignKey: 'productId', onDelete: 'CASCADE' })
Product.hasMany(Evaluation, { as: 'evaluations', foreignKey: 'productId', onDelete: 'CASCADE' })
